...
<span class="category"><b><?php the_author(); ?></b> [<?php the_time(get_option('date_format')); echo " "; the_time(); ?>] &mdash; <?php if($lw_disable_tags == "true" || !get_the_tags()) { _e('Filed under:','lightword'); echo " "; the_category(', ');} else if (get_the_tags() && $lw_disable_tags == "false") { _e('Tagged as:','lightword'); echo " "; the_tags(''); } ?></span>
